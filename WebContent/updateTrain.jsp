...
<body bgcolor="gainsboro">
	<div>
		<h1>修改车次</h1>
		<form action="<%=path%>/UpdateTrainServlet" method="get" onsubmit="return IsAddUser()">
				...
				<tr>
					<td colspan="2">
						<center>
							...
							<a href="<%=path%>/QueryTrainServlet?setcurrentpage=1"><input type="submit" name="submit" value="取消" /></a>
						</center>
					</td>
				</tr>
			</table>
